        ...
        <Row className='d-flex align-items-center'>
            <Col>
                <div class="d-flex align-items-center gap-5"> 
                    <div>
                        <h1 class="fw-semibold">TV Shows</h1>
                    </div>
                   
                    <div class="dropdown">
                            <button class="btn btn-dark border rounded-0 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Genres
                            </button>
            ...
            <Col className='d-flex justify-content-end text-secondary'>
                <div class="border p-2 px-3 d-flex align-items-center">
