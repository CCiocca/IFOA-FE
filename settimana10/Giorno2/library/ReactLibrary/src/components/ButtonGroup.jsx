...
const ButtonGroup = ({setList}) => {
    const categories = [
        {catName: 'Fantasy',
        catNameJson: FantasyBooks},
    
        {catName: 'History',
        catNameJson: HistoryBooks},
    
        {catName: 'Horror',
        catNameJson: HorrorBooks},
    
        {catName: 'Romance',
        catNameJson: RomanceBooks},
    
        {catName: 'Scifi',
        catNameJson: ScifiBooks},
    ...
    return (
        <div className="text-center py-3">
          ...
          <Button variant="success" onClick={() => setList(category.catNameJson)} key={index}>{category.catName}</Button>
          )}
